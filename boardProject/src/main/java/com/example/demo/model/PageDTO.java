...
public class PageDTO {
    ...
    public PageDTO(int currentPage, int cntPerPage, int pageSize) {
		/*
		 * //강제입력방지 if (currentPage < 1) { currentPage = 1; } //10,20,30개 단위 이외 처리 방지 if
		 * (cntPerPage != 10 && cntPerPage != 20 && cntPerPage != 30) { cntPerPage = 10;
		 * }
		 * 
		 * if(cntPerPage == 5) { cntPerPage = 5; }
		 * 
		 * // 하단 페이지 갯수 10개로 제한 if (pageSize != 10) { pageSize = 10; }
		 */
